...
struct MockCandidatesList {
    ...
    [ Candidate(id: "id_001", firstName: "Bruce", lastName: "Dickinson", email: "numberofthebeast@gmail.com", phone: "0666666666", isFavorite: true, linkedinURL: "https://www.linkedin.com/in/leplard-yannick", note: "Ideoque fertur neminem aliquando ob haec vel similia poenae addictum oblato de more elogio revocari iussisse, quod inexorabiles quoque principes factitarunt. et exitiale hoc vitium, quod in aliis non numquam intepescit, in illo aetatis progressu effervescebat, obstinatum eius propositum accendente adulatorum cohorte."),
      ...
      Candidate(id: "id_004", firstName: "Ozzy", lastName: "Osbourne", email: "princeofdarkness@gmail.com", phone: "0766666666", isFavorite: true, linkedinURL: nil, note: nil),
      Candidate(id: "id_005", firstName: "Michael", lastName: "Kiske", email: "helloween@gmail.com", phone: "0604030905", isFavorite: true, linkedinURL: nil, note: nil)
    ]
}
